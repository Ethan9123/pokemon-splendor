...
| 卡名 | 等级 | 效果 | 是否需玩家交互 |
|---|---|---|---|
| **EVOLVE STONE（进化石）** | 3 | 购买时立即从**等级 2 行**免费取 1 张面朝上的基础/Pokémart 卡（不付成本、结算其效果、不算购买）。本卡自带固定折扣球。 | 是（选免费卡）|
...
| **TM（技能机, 磁盘）** | 1 | 购买时，选你场上**另一张有奖励的卡**，本卡颜色/奖励永久视同该卡（本卡无自带颜色）。无该类卡则不能买。 | 是（选卡）|
